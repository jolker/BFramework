 ...
 */
package com.bliss.framework.common;

import com.bliss.framework.util.ConvertUtils;
import com.bliss.framework.util.SlackUtils;
import java.io.File;
...
//        GA.app.error(str);
    ...
    public static void debug(int userid, String debug) {
        if (userid == USERID_DEBUG || USERID_DEBUG == -1) {
            printDebugAll(debug);
        }
    }

    public static int USERID_DEBUG = ConvertUtils.toInt(Config.getParam("debug", "userid"), 718454839);
}
