package com.bliss.framework.ipchecking;

import com.bliss.framework.util.FileUtils;
import com.bliss.framework.util.NetworkUtils;
import java.io.File;
            ...
            if (listConfig != null) {
                for (int i = 0; i < listConfig.length; i++) {
                    ...
                    if (value != null) {
                        ...
                        IPRange range = NetworkUtils.ipRangeToRangeNumber(rule.fileterKey);
                        mVietnamIP.put(range.lower, range.upper);
                    }
                }
            }
        }
