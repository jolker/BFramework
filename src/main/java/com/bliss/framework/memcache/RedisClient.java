 ...
 */
package com.bliss.framework.memcache;
...
public class RedisClient {
    ...
    public void invalidClient(Jedis client) {
    ...
    public List<String> sort(String key, SortingParams sort) throws Exception {
        Jedis client = null;

        try {
            client = borrowClient();
            List<String> result = client.sort(key, sort);
            returnClient(client);
